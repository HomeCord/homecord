...
module.exports = {
    ...
    async execute(interaction)
    {
        ...
        const SupportActionRow = new ActionRowBuilder().addComponents([
            new ButtonBuilder().setStyle(ButtonStyle.Link).setLabel(localize(interaction.locale, 'SUPPORT_COMMAND_DOCS_BUTTON_LABEL')).setURL("https://homecord.gitbook.io/docs"),
